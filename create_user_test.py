...
# El resultado de la solicitud de recepción de datos de la tabla "user_model" se guarda
# en la variable "users_table_response"
...
# Prueba 3. Creación de un nuevo usuario -  Error
# El parámetro "firstName" contiene 1 carácter
def test_create_user_1_letter_in_first_name_get_error_response():
    negative_assert_symbol("A")

# Prueba 4. Creación de un nuevo usuario -  Error
# El parámetro "firstName" contiene 16 caracteres
def test_create_user_16_letter_in_first_name_get_error_response():
    negative_assert_symbol("Aaaaaaaaaaaaaaaa")

# Prueba 5. Creación de un nuevo usuario -  Error
# El parámetro "firstName" contiene palabras con espacios
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("A Aaa")

# Prueba 6. Creación de un nuevo usuario -  Error
# El parámetro "firstName" contiene un string de caracteres especiales
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("\"№%@\",")

# Prueba 7. Creación de un nuevo usuario -  Error
